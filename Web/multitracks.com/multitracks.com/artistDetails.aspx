    ...
    <form runat="server">
        ...
        <div class="wrapper mod-standard mod-gray">
            <div class="details-banner">
                ...
                <div runat="server" class="details-banner--hero">
                    <asp:Image ID="Hero" runat="server" />
                </div>
                <div runat="server" class="details-banner--info">
                    <a runat="server" href="#" class="details-banner--info--box">
                    ...
                    <section class="standard--holder">
                        ...
                        <ul runat="server" id="playlist" class="song-list mod-new mod-menu">
                            <asp:Repeater runat="server" ID="songList">
                                ...
                                <div runat="server" class="song-list--item--player-img media-player">
<%--                                    <asp:Image runat="server" ImageUrl='<%#Eval("")%>' />--%>
